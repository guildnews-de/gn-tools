...
<div id="intro">
    ...
    <p>Ich habe gesagt <em>beinahe</em>, weil ich bisher nicht Items und Gold beobachten kann, das im Handelsposten darauf wartet aufgenommen zu werden. Sobald ArenaNet eine neue API hinzugefügt, um diese Informationen zu erhalten, werde ich die
        Applikation updaten.</p>
    <p>Sei dir bewusst, dass in einigen Fällen es dazu kommen kann, dass es 2 oder 3 Refreshes benötigt bis erhaltene oder verlorene Items auftauchen. Die API gibt keine Live Daten zurück, jedes mal wenn sie aufgerufen wird. Sei also bitte geduldig
        :)</p>
    <hr>
    ...
    <p>Du besitzt keinen? Gehe auf <a href="https://www.guildwars2.com/" target="_blank">guildwars2.com</a> und logge dich in deinen Account ein. Dann erstelle im <strong>Applikationen</strong> Tab einen neuen API Schlüssel. Achte darauf, dass du die
        Berechtigungen für <em>wallet, tradingpost, account, inventories</em> und <em>characters</em> gesetzt hast.</p>
...
<div id="aboutPopup">
    ...
    <hr>
    <p>I had some free time and I wanted to do something useful for the community. I hope you enjoy it as much as I had doing this project! A special thanks to my friends who helped me test this application. If you find bugs or have any suggestion on
        how I could improve it, send me an in-game mail at <strong>Deviljeff.1946</strong> or a private message on <a href="https://www.reddit.com/message/compose/?to=Deviljeff" target="_blank" title="Send a private message on reddit">Reddit</a>.</p>
</div>
